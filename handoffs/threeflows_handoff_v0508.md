...
## Version 0508 — Updated May 8, 2026
...
- Tab switching: `setTab(idx)` toggles `tab-0` through `tab-3` by ID
...
- Sections: Hero → Continuity banner → Philosophy → Services split → Control tower → What you keep → Growth path → FAQ → Bottom CTA
